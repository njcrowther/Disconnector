...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/disconnector.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var doc = sketch.getSelectedDocument(); //Gets the sketch document

  var selection = doc.selectedLayers; // Gets the currently selected artboards or layers

  var selectedCount = selection.length; // Variable I'm using just to log things and make sure it's selecting everything.
  // function that handles artboards, groups, symbol

  selection.forEach(function (selected) {
    if (selected.type === 'Artboard') {
      //get array of layers. send to detatcher
      artboardDetatcher(selected);
    } else if (selected.type === 'Group') {
      // for each object. send to detatcher
